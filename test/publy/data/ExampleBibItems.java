...
public class ExampleBibItems extends ArrayList<BibItem> {
    ...
    public ExampleBibItems() {
        ...
        item.put("paper", "publications/papers/2014/Bose, Lubiw, Pathak, Verdonschot - Flipping Edge-Labelled Triangulations.pdf");
        ...
        item.put("paper", "publications/papers/2014/Barba, Bose, Damian, Fagerberg, ORourke, van Renssen, Taslakian, Verdonschot - New and Improved Spanning Ratios on Yao Graphs.pdf");
        ...
        item.put("paper", "publications/papers/2014/Morin, Verdonschot - On the Average Number of Edges in Theta Graphs.pdf");
        ...
        item.put("paper", "publications/papers/2013/Barba, De Carufel, Fleischer, Kawamura, Korman, Okamoto, Tang, Tokuyama, Verdonschot, Wang - The Inverse Barycenter Problem.pdf");
        item.put("status", "submitted");
        add(item);
        ...
        item.put("paper", "publications/papers/2013/Aichholzer, Bae, Barba, Bose, Korman, van Renssen, Taslakian, Verdonschot - Theta-3 is connected.pdf");
        ...
        item.put("paper", "publications/papers/2013/Barba, Bose, De Carufel, van Renssen, Verdonschot - On the stretch factor of the Theta-4 graph.pdf");
        ...
        item.put("paper", "publications/papers/2013/Bose, Morin, van Renssen, Verdonschot - The theta_5-graph is a spanner.pdf");
        ...
        item.put("paper", "publications/papers/2012/Bose, Fagerberg, van Renssen, Verdonschot - Competitive Routing on a Bounded-Degree Spanner (CCCG).pdf");
        ...
        item.put("paper", "publications/papers/2012/Buchin, Speckmann, Verdonschot - Evolution Strategies for Optimizing Rectangular Cartograms (GIScience 2012).pdf");
        ...
        item.put("paper", "publications/papers/2012/Buchin, Speckmann, Verdonschot - On the Number of Regular Edge Labelings (DMTCS).pdf");
        ...
        item.put("paper", "publications/papers/2012/Bose, Jansens, van Renssen, Saumell, Verdonschot - Making triangulations 4-connected using flips (CGTA).pdf");
        ...
        item.put("paper", "publications/papers/2012/Bose, Fagerberg, van Renssen, Verdonschot - On Plane Constrained Bounded-Degree Spanners (LATIN 2012).pdf");
        ...
        item.put("paper", "publications/papers/2012/Bose, Verdonschot - A History of Flips in Combinatorial Triangulations.pdf");
        ...
        item.put("paper", "publications/papers/2012/Bose, Fagerberg, van Renssen, Verdonschot - Competitive Routing on the Half-theta_6-Graph (SODA 2012).pdf");
        ...
        item.put("paper", "publications/papers/2011/de Berg, Khosravi, Verdonschot, van der Weele - On Rectilinear Partitions with Minimum Stabbing Number (WADS 2011).pdf");
        ...
        item.put("paper", "publications/papers/2011/Bose, Jansens, van Renssen, Saumell, Verdonschot - Making triangulations 4-connected using flips (CCCG 2011).pdf");
        ...
        item.put("paper", "publications/papers/2011/Buchin, Speckmann, Verdonschot - Optimizing Regular Edge Labelings (GD 2010).pdf");
        ...
        item.put("paper", "publications/papers/2010/Verdonschot - Optimizing Regular Edge Labelings (Master Thesis).pdf");
        add(item);
    }
}
